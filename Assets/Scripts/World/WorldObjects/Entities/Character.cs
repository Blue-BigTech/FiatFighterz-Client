...
public class Character : Entity
{
    ...
    public string token_id; // data nessesary for the character menu to retreive the right NFT

    public string owner_of;

    public string metadata;

    public string characterhat, characterclass, characterrace, characterskin;

    public string characterdyecolor1, characterdyecolor2;
    ...
    public void parseNFTMetadata(string metadata)
    {
