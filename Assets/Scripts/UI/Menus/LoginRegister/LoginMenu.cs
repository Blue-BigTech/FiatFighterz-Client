...
public class LoginMenu : MonoBehaviour
{
    ...
    // remove references to webclient describe
    ...
    public void setLoginResponse(WebClient.Response<WebLoginResponse> response)
    {
    ...
    public void setforgotresponse(WebClient.Response<WebLoginResponse> res)
    {
        this.forgotResponse = res;
    }

    public void setdescriberesponse(WebClient.Response<WebDescribeResponse> res)
    {
        this.describeResponse = res;
    }
...
/*
    ...
    {   
        ...
        overlay.SetActive(true);
        WebClient.SendWebLogin(email, password, PlayerPrefs.GetString("signedCryptoMessage") ,OnLoginResponse);
    }
*/
    ...
    private void LateUpdate()
    {
            ...
            else
            {
                switch (loginResponse.item.result)
                {
                    ...
                    case WebLoginResult.InvalidHash:
                        errorLabel.text = "Invalid credentials, please try again.";
                        break;
                    case WebLoginResult.InvalidCtyptoAddress:
                        errorLabel.text = "Invalid message signature";
                        break;
                    default:
        ...
        if (describeResponse != null)
        {
            ...
            if (describeResponse.exception != null)
            {
                ...
                ApplicationAlert.Show("Uh oh..", $"Unable to get a response from the cardi b", UnverifiedButtonPressed, "Back", "Retry");
            }
