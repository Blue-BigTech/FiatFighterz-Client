...
public class RegisterMenu : MonoBehaviour
{
    ...
    private async void OnMessageResponse(WebClient.Response<WebMessageResponse> response)
    {
        ...
        WebClient.SendWebRegister(email, password, message, signature, OnRegisterResponse);
    }
    ...
    private string GetFieldError(string email, string password, string passwordConfirm)
    {
        ...
        if (!over13Toggle.isOn) return "You must be at least 13 years of age to play. Hi my naem is hermin AHHHHHHGGGHHHHHH winstead reehehehehehehe";
